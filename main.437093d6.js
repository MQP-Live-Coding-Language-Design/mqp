...
function () {
  ...
  _createClass(Note, [{
    ...
    value: function trigger(par, inst, time) {
      ...
      var nxtTime = Tone.Time(time + this.gap); // schedules retrigger of parent
...
function () {
  ...
  _createClass(Audio, [{
    ...
    value: function trigger(par, inst, time) {
      ...
      var nxtTime = Tone.Time(time + this.gap); // schedules a retrigger of parent for when it plays
...
function () {
  ...
  _createClass(Part, [{
    ...
    value: function start() {
      if (!this.running) {
        var now = Tone.Time(Tone.Transport.position);
